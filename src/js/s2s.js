...
let s2s = {
    getData: async function (data, map) {
        ...
        for (var i = 0; i < data.default.length; i++) {
            ...
            var school_popuptext = "<h3>" + data.default[i].title + "</h3><br/>";
            ...
            if (typeof data.default[i].website != 'undefined') {
                ...
                school_popuptext += "<a href='" + data.default[i].website + "' target='_blank' rel='noreferrer'>" + data.default[i].website + "</a><br />";
            }
